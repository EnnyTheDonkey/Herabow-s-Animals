package net.mcreator.herabowsanimals.procedures;
...
@EventBusSubscriber
public class LootTablesProcedure {
	@SubscribeEvent
		...
		if (entity instanceof MouseEntity) {
			if (1 == Mth.nextInt(RandomSource.create(), 1, 3) ? true : false) {
				if (world instanceof ServerLevel _level) {
					ItemEntity entityToSpawn = new ItemEntity(_level, x, y, z, new ItemStack(HerabowsAnimalsModItems.MOUSE_MEAT.get()));
