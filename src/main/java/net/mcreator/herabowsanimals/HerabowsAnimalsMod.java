package net.mcreator.herabowsanimals;
...
@Mod("herabows_animals")
public class HerabowsAnimalsMod {
	public static final Logger LOGGER = LogManager.getLogger(HerabowsAnimalsMod.class);
	public static final String MODID = "herabows_animals";

	public HerabowsAnimalsMod(IEventBus modEventBus) {
